...
class Network(nn.Module):
    ...
    def save(self, epoch):
        print('model saved')
        torch.save(self.state_dict(), self.scenario + '/' + '-' + self.mode + '/'+ '-' + str(self.seed)+'/MM_DTSQN_H_' + str(epoch) + '.pth')

    def load(self, epoch):
        print('load model')
        self.load_state_dict(torch.load(self.scenario + '/' + '-' + self.mode + '/'+ '-' + str(self.seed)+'/MM_DTSQN_H_' + str(epoch) + '.pth'))